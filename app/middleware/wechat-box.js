...
const apiKey = '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';
...
/*async function sendWeChatMessage(xml) {
...
/*async function getAccessToken() {
  const fetch= await getFetch();
  const response = await fetch(`${weUrl}?grant_type=client_credential&appid=${AppId}&secret=${AppSecret}`);
